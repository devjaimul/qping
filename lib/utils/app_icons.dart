class AppIcons {
  ...
  static const String password = "$path/password.png";
  static const String person = "$path/person.png";
  static const String pen = "$path/pen.png";
  static const String phone = "$path/phone.png";
  static const String gender = "$path/gender.png";
